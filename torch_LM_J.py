...
class LM(object):
    ...
    """
    def __init__(self, function, X, Y, lambda0, W = None, max_iter = 100, epsilon4 = 1e-1, Lup = 11., Ldn = 9., L0 = 1e0):
    ...
    def main_loop(self):
        ...
        while self.iteration < self.max_iter and count_reject < 12 and count_finish < 3 and torch.all(torch.isfinite(self.lambda_new)):
            ...
            with torch.no_grad():
                ...
                Ynew = self.function(self.lambda_new + h).view(-1)
